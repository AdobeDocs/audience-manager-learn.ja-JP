---
title: Audience Manager ユーザー向けのReal-Time CDPの特性について
description: Audience ManagerからAdobe Real-Time CDPに移行する際には、概念の違いを理解しておくことが役立ちます。 このビデオでは、Audience Managerの特性と、Real-time CDPでの同等の機能について説明します。
...
# Audience Manager ユーザー向けのReal-Time CDPの特性について
