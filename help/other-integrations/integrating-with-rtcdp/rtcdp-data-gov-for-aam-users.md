---
title: Audience Manager ユーザー向けのReal-Time CDPのデータガバナンスについて
description: このビデオでは、Audience Manager ユーザーがReal-time Customer Data Platformのデータガバナンス機能を順を追って説明し、Audience Managerで利用可能なものと比較します。 ここでは、データ使用およびラベル付けの実施（DULE）フレームワークと、Platformのどこで適用できるかを説明します。
...
# Audience Manager ユーザー向けのReal-Time CDPのデータガバナンスについて

このビデオでは、Audience Manager ユーザーがReal-time Customer Data Platformのデータガバナンス機能を順を追って説明し、Audience Managerで利用可能なものと比較します。 ここでは、データ使用およびラベル付けの実施（DULE）フレームワークと、Platformのどこで適用できるかを説明します。

>[!VIDEO](https://video.tv.adobe.com/v/3410874/?captions=jpn&quality=12&learn=on)
