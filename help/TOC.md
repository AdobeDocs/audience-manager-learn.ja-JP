...
+ Audience Managerの概要 {#intro-to-audience-manager}
   + [DMPでビジネスを変える方法](intro-to-audience-manager/how-a-dmp-can-change-your-business.md)
   ...
   + [基本的な用語と概念](intro-to-audience-manager/understanding-basic-terms-and-concepts-in-audience-manager.md)
...
+ 設定と管理者 {#setup-and-admin}
   + データソース {#data-sources}
      ...
      + [クロスデバイスのデータソースを作成し](setup-and-admin/data-sources/creating-a-cross-device-data-source-and-authenticating.md)
   + ユーザー管理 {#user-management}
      + [ロールベースのアクセス制御で権限を設定する](setup-and-admin/user-management/setting-permissions-with-role-based-access-control.md)
   + データガバナンスとプライバシー {#data-governance-and-privacy}
      + [グローバルデバイス IDの検証](setup-and-admin/data-governance-and-privacy/global-device-id-validation.md)
      + [IAB TCF 2.2のサポート](setup-and-admin/data-governance-and-privacy/iab-tcf-support.md)
      + [各国のIP難読化](setup-and-admin/data-governance-and-privacy/ip-obfuscation-by-country.md)
   + 利用状況と請求 {#usage-and-billing}
      + [アクティビティの使用状況に関する監視とレポート](setup-and-admin/usage-and-billing/monitoring-and-reporting-on-activity-usage.md)
+ web実装 {#web-implementation}
   ...
   + [パートナーIDまたはサブドメインの特定方法](web-implementation/how-to-identify-your-partner-id-or-subdomain.md)
...
+ Audience Marketplace {#audience-marketplace}
   + 購買データ {#buying-data}
      ...
      + [Audience Marketplaceへのデータの一括アップロード](audience-marketplace/buying-data/bulk-uploading-data-usage-into-the-audience-marketplace.md)
      + [フィルターとレコメンデーションを使用して、Audience Marketplaceでサードパーティデータを選択します](audience-marketplace/buying-data/using-filters-and-recommendations-to-choose-3rd-party-data-in-audience-marketplace.md)
   + データの販売 {#selling-data}
      + [Marketplaceでのオウンドオーディエンスの商業化](audience-marketplace/selling-data/commercialize-owned-audiences-on-marketplace.md)
+ オーディエンスの構築と管理 {#build-and-manage-audiences}
   + Data Explorer {#data-explorer}
      + [Signals ダッシュボードを使用すると、使用可能な上位のシグナルをすばやく表示できます](build-and-manage-audiences/data-explorer/using-the-signals-dashboard-to-quickly-view-top-available-signals.md)
      + [Data Explorerを使用して、使用されているキーと未使用のキー/値のペアを検索する](build-and-manage-audiences/data-explorer/using-data-explorer-to-search-for-used-and-unused-key-value-pairs.md)
      + [検索した内容をData Explorerに保存して便利に再利用](build-and-manage-audiences/data-explorer/saving-searches-in-data-explorer-for-convenience-in-re-use.md)
      + [Data Explorerを使用して、遡及的な特性とセグメント化を作成する](build-and-manage-audiences/data-explorer/using-data-explorer-to-create-retroactive-traits-and-segments.md)
      + [Data Explorerを使用して、オンボーディングデータの特性作成を検証する](build-and-manage-audiences/data-explorer/using-data-explorer-to-validate-trait-creation-for-your-onboarded-data.md)
      + [Data Explorerを使用して、Adobe Analyticsからのシグナルを処理します](build-and-manage-audiences/data-explorer/using-data-explorer-to-work-with-signals-coming-from-adobe-analytics.md)
   + 特性とセグメント {#traits-and-segments}
      + [Analytics データから特性の作成を計画する](build-and-manage-audiences/traits-and-segments/planning-trait-creation-from-analytics-data.md)
      ...
      + [オンボーディング特性の作成](build-and-manage-audiences/traits-and-segments/creating-onboarded-traits.md)
      ...
      + [TTL （Time to Live）設定による特性の有効期限の設定](build-and-manage-audiences/traits-and-segments/configuring-trait-expiration-with-the-time-to-live-ttl-setting.md)
      + [コードビューを使用した特性の作成と編集](build-and-manage-audiences/traits-and-segments/using-code-view-to-create-and-edit-traits.md)
      + [バルク管理（BAAAM）の概要](build-and-manage-audiences/traits-and-segments/introduction-to-bulk-management-baaam.md)
      + [BAAAMで特性を一括作成および管理](build-and-manage-audiences/traits-and-segments/creating-and-managing-traits-in-bulk-with-baaam.md)
      ...
      + [複数のデータソースからセグメントを作成し](build-and-manage-audiences/traits-and-segments/creating-segments-from-multiple-data-sources.md)
      ...
      + [セグメントの構築時にコードビューを使用する](build-and-manage-audiences/traits-and-segments/using-code-view-when-building-segments.md)
      ...
      + [顧客に広告を表示しないセグメントを構築する](build-and-manage-audiences/traits-and-segments/building-a-segment-to-suppress-ads-to-customers.md)
      + [Audience Managerセグメントの配信先へのマッピング](build-and-manage-audiences/traits-and-segments/mapping-audience-manager-segments-to-destinations.md)
      ...
      + [顧客のヒント – 特性とセグメントのベストプラクティス](build-and-manage-audiences/traits-and-segments/customer-tips-traits-and-segments-best-practices.md)
   + アルゴリズムモデル {#algorithmic-models}
      + [予測オーディエンスについて](build-and-manage-audiences/algorithmic-models/understanding-predictive-audiences.md)
      ...
      + [1st パーティモデルの構築](build-and-manage-audiences/algorithmic-models/creating-a-first-party-look-alike-model.md)
      + [アルゴリズム（類似）モデルの特性の除外](build-and-manage-audiences/algorithmic-models/excluding-traits-in-algorithmic-look-alike-models.md)
      + [アルゴリズム（類似）モデルを利用してROASを向上](build-and-manage-audiences/algorithmic-models/increase-roas-by-using-algorithmic-look-alike-models.md)
      + [類似モデルを使用して、1st パーティデータから売り切れた在庫を拡張](build-and-manage-audiences/algorithmic-models/using-look-alike-models-to-extend-sold-out-inventory-from-your-1st-party-data.md)
   + プロファイル結合 {#profile-merge}
      ...
      + [プロファイル結合ルールを使用して、認証済み状態でパーソナライズします](build-and-manage-audiences/profile-merge/using-profile-merge-rules-to-personalize-in-an-authenticated-state.md)
      + [デバイスの拡張とリーチの拡大にプロファイル結合ルールを使用する](build-and-manage-audiences/profile-merge/using-profile-merge-rules-for-device-extension-and-increased-reach.md)
      + [プロファイル結合ルールの機能強化の概要](build-and-manage-audiences/profile-merge/overview-of-profile-merge-rule-enhancements.md)
      + [プロファイル結合ルールの機能強化 – 前提条件](build-and-manage-audiences/profile-merge/profile-merge-rule-enhancements-pre-requisites.md)
      + [プロファイル結合ルールの機能強化がセグメンテーション、アクティベーション、レポートに与える影響](build-and-manage-audiences/profile-merge/how-profile-merge-rule-enhancements-impact-segmentation-activation-and-reporting.md)
      ...
      + [お客様のヒント – プロファイル結合ルールを最大限に活用する](build-and-manage-audiences/profile-merge/customer-tips-getting-the-most-out-of-profile-merge-rules.md)
+ データの活性化 {#data-activation}
   + 宛先の基本 {#destinations-basics}
      ...
      + [一致率の把握](data-activation/destinations-basics/understanding-match-rates.md)
   ...
   + Audience Lab {#audience-lab}
      + [Audience Labを使用したDSPの選定](data-activation/audience-lab/using-audience-lab-to-choose-a-dsp.md)
      + [コンバージョン特性の構築](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/creating-conversion-traits.html?lang=ja)
   + People-based Destinations {#people-based-destinations}
      + [ピープルベースの配信先のビデオとチュートリアル](data-activation/people-based-destinations/pbd.md)
      + [ピープルベースの宛先データフロー](data-activation/people-based-destinations/people-based-destinations-data-flow.md)
      + [ピープルベースの宛先のデータソースの作成](data-activation/people-based-destinations/creating-a-data-source-for-people-based-destinations.md)
      + [People-based Destinationsのハッシュ化されたPII データ取り込みについて](data-activation/people-based-destinations/understanding-hashed-pii-data-ingestion-for-people-based-destinations.md)
      + [ピープルベースの宛先用にハッシュ化されたPIIを取り込む](data-activation/people-based-destinations/ingesting-hashed-pii-for-people-based-destinations.md)
      + [setCustomerIDs （）を使用して、PIIを宣言されたIDとして取り込み、ハッシュ化します](data-activation/people-based-destinations/using-setcustomerids-to-ingest-and-hash-pii-as-a-declared-id.md)
      + [ピープルベースの宛先のプロファイル結合ルールの設定](data-activation/people-based-destinations/configuring-profile-merge-rules-for-people-based-destinations.md)
      + [ピープルベースの宛先用のセグメントの作成](data-activation/people-based-destinations/creating-segments-for-people-based-destinations.md)
      + [ピープルベースの宛先の作成と設定](data-activation/people-based-destinations/create-and-configure-people-based-destinations.md)
      + [LinkedIn People ベースの宛先の理解と設定](data-activation/people-based-destinations/understanding-and-configuring-the-linkedin-pbd.md)
      + [Google customer-match People-based destinationの理解と設定](data-activation/people-based-destinations/understanding-and-configuring-the-google-customer-match-pbd.md)
+ レポート {#reports}
   + [特性とセグメントに関する一般的なレポートの使用](reports/using-general-reports-with-traits-and-segments.md)
   + [特性やセグメントに関するトレンドレポートを利用して](reports/using-trended-reports-with-traits-and-segments.md)
   + [重複レポートで関連オーディエンスを把握](reports/understand-related-audiences-with-overlap-reports.md)
...
+ その他の統合 {#other-integrations}
   + Adobe Real-Time CDPとの統合 {#integrating-with-rtcdp}
      ...
      + [Adobe Real-Time CDPの特性を理解する](other-integrations/integrating-with-rtcdp/rtcdp-traits-for-aam-users.md)
      + [Adobe Real-Time CDPのシグナルを理解する](other-integrations/integrating-with-rtcdp/rtcdp-signals-for-aam-users.md)
      + [Adobe Real-Time CDPでセグメントを把握](other-integrations/integrating-with-rtcdp/rtcdp-segments-for-aam-users.md)
      + [Adobe Real-Time CDPの宛先について](other-integrations/integrating-with-rtcdp/rtcdp-destinations-for-aam-users.md)
      + [Adobe Real-Time CDPのアクセス制御の詳細](other-integrations/integrating-with-rtcdp/rtcdp-access-control-for-aam-users.md)
      + [Adobe Real-Time CDPのデータガバナンスの詳細](other-integrations/integrating-with-rtcdp/rtcdp-data-gov-for-aam-users.md)
...
+ API {#api}
   + [Adobe DeveloperでのAPI資格情報の取得](api/retrieve-api-credentials-in-adobe-io.md)
