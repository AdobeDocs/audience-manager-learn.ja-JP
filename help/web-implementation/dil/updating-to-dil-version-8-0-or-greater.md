...
* [!DNL DIL.create]を使用する場合、一部の要素は非推奨（廃止予定）になっており、代わりにECID要素を使用する必要があります。 これらの要素は、[[!DNL DIL.create]  ドキュメント &#x200B;](https://experienceleague.adobe.com/docs/audience-manager/user-guide/dil-api/class-level-dil-methods/dil-create.html?lang=ja)で説明されています。
* [!DNL idSync] インスタンスレベルのメソッドも、メソッドの[&#x200B; ドキュメント &#x200B;](https://experienceleague.adobe.com/docs/audience-manager/user-guide/dil-api/dil-instance-methods.html?lang=ja)で説明されているように、非推奨（廃止予定）になりました。
